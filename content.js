    ...
    if (currentTime > 0) {
      ...
      const trySetCurrentTime = () => {
        if (videoElement.readyState >= 2) {
          ...
          if (videoElement.duration && videoElement.duration - currentTime < 5) {
          ...
          console.log(`loadProgress: Successfully set currentTime for ${videoId} to ${currentTime}`);
      ...
      console.log(`loadProgress: No saved time found for ${videoId} or saved time is 0.`);
    }
  });
}
